...
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
    ...
    <!--Nav-->
    <nav class="bg-gray-100 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
...
<!-- 
            <div class="flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-2">
                <span class="relative w-full">
                    <input type="search" placeholder="Search" class="w-full bg-gray-300 text-white transition border border-transparent focus:outline-none focus:border-gray-400 rounded py-3 px-2 pl-10 appearance-none leading-normal">
...
<!-- 
<div class=" w-full md:w-1/2 xl:w-1/3  p-6">
                        <div class="bg-gray-500 border-blue-600 rounded-lg shadow-xl p-5  items-center">
                            <div class="flex-none text-right md:text-center">
                                <h5 class="font-bold uppercase text-black">Monthly Expense</h5>
                                <h3 class="font-bold text-3xl text-white">12,300 </h3>
                            </div>
                        </div>
                    </div> -->